      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            ...
            {/* User avatar */}
            <div className="ml-1.5 flex h-8 w-8 items-center justify-center overflow-hidden rounded-full ring-2 ring-white/20 transition-all hover:ring-indigo-400/50 bg-gradient-to-br from-indigo-500 to-purple-500">
              ...
              <div className="overflow-y-auto px-4 py-6">
                ...
                <div className="mt-6 border-t border-white/10 pt-6">
                  <div className="flex items-center gap-3 rounded-lg bg-white/5 px-3 py-3">
                    <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full ring-2 ring-white/20 bg-gradient-to-br from-indigo-500 to-purple-500">
