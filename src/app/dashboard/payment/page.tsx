...
import { Shield, Loader2, AlertCircle, CheckCircle2, CreditCard, Star, Zap } from "lucide-react"
...
const PLANS = {
  STANDARD: {
    ...
    features: [
      ...
      "Project assignments",
      "Public or private profile creation",
      "Portfolio support",
  ...
  PLUS: {
    ...
    description: "An enhanced experience with personalised guidance and review.",
    features: [
      "Everything in Standard Fellowship",
      "Individual pathway review",
      "Enhanced one-to-one guidance",
      "Additional portfolio support",
      "Professionally structured contribution profile",
      "Personalised progression review",
    ],
  },
}
              ...
              {isTestMode && (
                <div className="mt-4 rounded-xl border border-amber-200 bg-amber-50 p-4">
                  ...
                  <p className="mb-3 text-xs text-amber-600">
                    Skip payment to test without real charges.
                  </p>
                  <Button
                    variant="outline"
                    size="sm"
