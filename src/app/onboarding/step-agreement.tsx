    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
      ...
      <div className="mt-6 rounded-xl border border-gray-200 p-5">
        ...
        <Input
          ...
          className="mt-3"
        />
        <p className="mt-2 text-xs text-gray-400">Selected pathway: {pathway === "PLUS" ? "Applied R&D & Technology Development \u2014 £7,500" : "TBP Global Strategist Fellowship \u2014 £2,500"}</p>
      </div>
